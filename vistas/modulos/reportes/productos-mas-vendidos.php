...
$colores = array("red","green","orange","aqua","purple","blue","cyan","magenta","yellow","gold");
...
<script>
  ...
  // Generar colores para la gráfica de dona
  var coloresDona = [
    <?php
  ...
  // Asignar colores a la gráfica de dona
  for (var i = 0; i < PieData.length; i++) {
    PieData[i].color = coloresDona[i % coloresDona.length];
    PieData[i].highlight = coloresDona[i % coloresDona.length];
  }
