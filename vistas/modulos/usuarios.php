          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <input type="file" class="nuevaFoto" name="editnuevaFoto">
              <input type="hidden" name="editnombreImagen" id="editnombreImagen"> <!-- Campo oculto para el nombre de la imagen -->
